...
public class UpdatePortfolioValidator implements Validator<UpdatePortfolio>{

	@Override
	public void validate(UpdatePortfolio obj) {
		String id = obj.getId();
		...
		verfyNotEmptyStringValue(id, "수정할 포트폴리오 아이디를 입력해주세요.", "id");
